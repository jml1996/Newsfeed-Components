...
const data = [
  ...
  },
  {
    ...
    thirdParagraph: `Hodor hodor - hodor... Hodor hodor hodor hodor. Hodor. Hodor! Hodor hodor, hodor hodor hodor hodor hodor; hodor hodor? Hodor!
          Hodor hodor, HODOR hodor, hoodor hodor?! Hodor! Hodor hodor, HODOR hodor, hodor hodor, hodor, hodor hodor. Hodor, hodor.
          Hodor. Hodor, hodor, hodor. Hodor hodor... Hodor hodor hodor?! Hodor, hodor... Hodor hodor HODOR hodor, hodor hodor. Hodor.`
  },
  {
    title: 'Light Again',
    date: 'December 21st, 2019',
    firstParagraph: `Hey it's MK.`,

    secondParagraph: `How's Stout?`,

    thirdParagraph: `All this you wish to renounce?`
  }
];
